...
const Hero = () => {
  return (
    <div className="w-full  hero flex items-center justify-center h-[100vh] bg-fuchsia-200 px-5 -mt-5">
      <div className="container mx-auto flex flex-col justify-between items-center md:flex-row -mt-20 sm:mt-0">
        <div className="container flex flex-col items-center md:items-start gap-10 text-center md:text-left">
          ...
          <div className="hidden sm:flex gap-4">
            <a href="/contact">
              <button className="text-gray-600 hover:text-white hover:bg-fuchsia-600 px-6 sm:px-10 py-4 rounded-md text-lg font-semibold border-r">
                Contact Us
              </button>
            </a>
